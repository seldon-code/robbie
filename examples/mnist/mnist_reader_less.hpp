...
{
    return read_mnist_image_file<Pixel>( "./examples/mnist/mnist_data/train-images-idx3-ubyte" );
}
...
{
    return read_mnist_image_file<Pixel>( "./examples/mnist/mnist_data/t10k-images-idx3-ubyte" );
}
...
{
    return read_mnist_label_file<Label>( "./examples/mnist/mnist_data/train-labels-idx1-ubyte" );
}
...
{
    return read_mnist_label_file<Label>( "./examples/mnist/mnist_data/t10k-labels-idx1-ubyte" );
}
